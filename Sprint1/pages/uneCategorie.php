            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <button class="btn btn-outline-dark" type="submit">
                        ...
                        <a href="Accueil.html"><img src="../images/cart.png" alt="Logo" height="80px" class="cart"/></a>
...
<!-- Nos Produit-->
<section class="py-5">
    <h2 class="text-center text-black display-4 fw-bolder">GPU</h2>  
        ...
        <div class="row gx-4 gx-lg-5 row-cols-2 row-cols-md-3 row-cols-xl-4 justify-content-center">
            <div class="col mb-5">
                <div class="card h-100">
                    ...
                    <!-- Product image-->
                    <img class="card-img-top" src="../images/Carte graphique 1.png" alt="Carte graphique 1" />
                    <!-- Product details-->
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <h5 class="fw-bolder">QUADRO GPU</h5>
                            <!-- Product reviews-->
            ...
            <div class="col mb-5">
                <div class="card h-100">
                    <!-- Product image-->
                    <img class="card-img-top" src="../images/Carte graphique 3.png" alt="Carte graphique 3">
                    <!-- Product details-->
                    <div class="card-body p-4">
                        <div class="text-center">
                            <!-- Product name-->
                            <h5 class="fw-bolder">MSI AMD RADEON GPU </h5>
                            <!-- Product reviews-->
                            <div class="d-flex justify-content-center small text-warning mb-2">
                                <div class="bi-star-fill"></div>
                                <div class="bi-star-fill"></div>
