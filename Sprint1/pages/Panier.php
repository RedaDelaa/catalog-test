...
<head>
    ...
    <script src="//code.jquery.com/jquery-1.11.1.min.js"></script><link rel="stylesheet" href="../Css/style3.css" />
...
<body>
    ...
    <div class="row">
        <div class="col-md-8 card">
               ...
               <!-- Retour accueil-->
                <div class="back-to-shop text-bg-dark text-center text-light" style="font-size: large;" ><a href="./Accueil.html">&leftarrow;</a><span class=" text-muted" ><span style=" color: white;">Retour au magasin</span></span></div>
            </div>
