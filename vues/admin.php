            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="ajouterArticle.php">Ajouter un Article</a></li>
                        <li><a class="dropdown-item" href="modifierArticle.php">Modifier un Article</a></li>
                        <li><a class="dropdown-item" href="chercherArticle.php">Chercher un Article</a></li>
                        <li><a class="dropdown-item" href="chercherArticleParCode.php">Chercher Article par Code</a></li>
                        <li><a class="dropdown-item" href="creation.php">Création</a></li>
                        <li><a class="dropdown-item" href="Panier.php">Gestion du Panier</a></li>
                        <li><a class="dropdown-item" href="paiement.php">Gestion des Paiements</a></li>
                    </ul>
                </li>
